      ...
      <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" readonly name="fname" id="inputfName4" value="<%= (String) (session.getAttribute("ffname"))%>" placeholder="First Name" required>
            </div>
            <div class="form-group col-md-6">
              <label for="inputlName4">Last Name</label>
              <input type="text" class="form-control" name="lname" readonly id="inputlName4" value='<%= lname%>' placeholder="Last Name" required>
            </div>
            <div class="form-group col-md-6">
              <label for="inputmName4">Middle Name</label>
              <input type="text" class="form-control" name="mname" readonly id="inputmName4" value='<%= mname%>' placeholder="Middle Name" required>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" class="form-control"  onblur="checkAge()" name="bday" id="dob" placeholder="MM/DD/YYYY"required>
            </div>
