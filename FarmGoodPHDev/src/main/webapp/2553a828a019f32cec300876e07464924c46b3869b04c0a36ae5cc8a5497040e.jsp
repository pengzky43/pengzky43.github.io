...
<body>
		<div class="fixed-bottom" style="padding-bottom: 50px; padding-right: 20px;">
		<script type="text/javascript">
		function collapse() {
		...
		<button type="button" onclick="collapse()"  id="messenger-icon" class="btn btn-default btn-circle btn-xl float-right" style="z-index: 100"><i class="fa fa-comment-alt fa-lg" id="DEADBEEF" style="text-align: center"></i></button>
		</div>
     <div class="container-fluid h-100" id="collapse1">
				...
				<div class="col-md-8 col-xl-6 chat">
					<div class="card">
						...
						<div class="card-footer">
							<form target="send" action="">
							<input type="hidden" name="action" value="send"/>
							<input type="hidden" name="receipient" value="pengzky43">
							<input type="hidden" name="sender" value="duhh">
							<div class="input-group">
								<div class="input-group-append">
									<span class="input-group-text attach_btn"><i class="fas fa-paperclip"></i></span>
								</div>
								<textarea name="" class="form-control type_msg" placeholder="Aa"></textarea>
								<div class="input-group-append">
